...
<div class="flex items-center">
  ...
  <div on:click={(e) => {
    siteMenuOpened = true;
    page = 2;
  }} style="width: 2rem; height: 2rem; background-image: url('https://i.pinimg.com/280x280_RS/fa/7f/62/fa7f62cd494ce11166cacf6f9075ec1a.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;" class="rounded-full mx-2 cursor-pointer"></div>

  <Popover placement="bottom-end" arrow={false} bind:open={siteMenuOpened} overlayColor="rgba(0,0,0,0.25)">
    <button on:click={(e) => {
      page = 1;
    }} slot="target" on:mouseover={(e) => button01Hovered = true} on:mouseout={(e) => button01Hovered = false} class="px-2 py-2 mx-2 hover:bg-white rounded-md relative">
    ...
    <div slot="content" class="pt-4 pr-8 md:pr-0 w-full md:w-auto min-w-screen md:min-w-26rem">
      <div class="bg-white relative rounded-md shadow-lg px-3 py-6">
        ...
        <div class="w-full flex flex-col items-center mb-6">
          <div class="flex items-center">
            <!-- Avatar -->
            <div style="width: 3.5rem; height: 3.5rem; background-image: url('https://i.pinimg.com/280x280_RS/fa/7f/62/fa7f62cd494ce11166cacf6f9075ec1a.jpg'); background-repeat: no-repeat; background-position: center; background-size: cover;" class="rounded-full mx-2 cursor-pointer"></div>

            <!-- Texts -->
            <div class="ml-2">
              <h1 class="text-black text-md">Марш Джеймсон</h1>
